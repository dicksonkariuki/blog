...
class PostForm(FlaskForm): #create a class that inherits from FlaskForm class
    category = SelectField('Choose Blog Category', choices =[('General','General'),('Cars','Cars'),('Technology','Technology'),('Lifestyle','Lifestyle'),('Agriculture','Agriculture'),('Health','Health'),('Finance','Finance'),('Tourism','Tourism'),('Religion','Religion')],validators=[Required()])
